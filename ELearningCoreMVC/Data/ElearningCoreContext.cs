...
namespace ELearningCoreMVC.Data;

public partial class ElearningCoreContext : DbContext
{
    public ElearningCoreContext()
    {
    }

    public ElearningCoreContext(DbContextOptions<ElearningCoreContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Pid).HasName("PK__cart__DD37D91A0DE01505");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__course__3213E83F57A52E5B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__User_acc__3214EC07A1C2F32C");
        ...
        {
            entity.HasKey(e => e.Vid).HasName("PK__videos__DDB00C7DB14BD6F9");
